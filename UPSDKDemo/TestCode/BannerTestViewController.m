...
@interface BannerTestViewController () <UPBannerWrapperProtocol>
{
    UPBannerRectangleWrapper *_bottomRectBanner;
    UPBannerStripWrapper *_topStripBanner;
    UPBannerStripWrapper *_bottomStripBanner;
...
- (void)loadRectangleBanner
{
    ...
    _bottomRectBanner = [[UPBannerRectangleWrapper alloc] initWithPlacement:@"banner_bbb" controller:self size:size];
...
{
    _topStripBanner = [[UPBannerStripWrapper alloc] initWithPlacement:@"banner_aaa" controller:self];
...
- (void)loadBottomStripBanner
{
    ...
    _bottomStripBanner = [[UPBannerStripWrapper alloc] initWithPlacement:@"banner_aaa" controller:self size:size];
...
#pragma mark UPBannerWrapperProtocol
